...
export default function EditLinkPage({ link, token }) {
  ...
  const [imagePreview, setImagePreview] = useState(
    link.image ? link.image.formats.thumbnail.url : null
  )
...
export async function getServerSideProps({ params: { slug }, req }) {
  ...
  // this is only accessible via node / server-side, not client side js
